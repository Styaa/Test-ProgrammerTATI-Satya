...
@section('content')
                ...
                <div class="card-body pt-4 p-3">
                    <form action="/user-profile" method="POST" role="form text-left">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="@error('user.name')border border-danger rounded-3 @enderror">
                                        <input class="form-control" value="{{ auth()->user()->nama }}" type="text"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="user-email" class="form-control-label">{{ __('Jabatan') }}</label>
                                    <div class="@error('email')border border-danger rounded-3 @enderror">
                                        <input class="form-control" value="{{ auth()->user()->jabatan->nama }}"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="atasan_id" class="form-control-label">{{ __('Atasan') }}</label>
                                        ...
                                        <select class="form-control" id="atasan_id" name="atasan_id">
                                            ...
                                            @foreach ($atasans as $atasan)
                                                <option value="{{ $atasan->id }}"
                                                    {{ old('atasan_id', auth()->user()->atasan_id) == $atasan->id ? 'selected' : '' }}>
                                                    {{ $atasan->nama }}
                                                </option>
                                            @endforeach
                                        </select>
    ...
    <script>
        var updateAtasan = "{{ route('update-atasan') }}";
