...
function navbarFixed(e) {
    ...
    e.getAttribute("checked") ? (n.classList.remove(...t), n.setAttribute("data-scroll", "false"), navbarBlurOnScroll("navbarBlur"), e.removeAttribute("checked")) : (n.classList.add(...t), n.setAttribute("data-scroll", "true"), navbarBlurOnScroll("navbarBlur"), e.setAttribute("checked", "true"))
}
...
function navbarBlurOnScroll(e) {
    ...
    window.onscroll = debounce("true" == e ? function () {
        ...
        o()
    }, 10), -1 < navigator.platform.indexOf("Win") && (n = document.querySelector(".main-content"), "true" == e ? n.addEventListener("ps-scroll-y", debounce(function () {
        (5 < n.scrollTop ? l : o)()
    }, 10)) : n.addEventListener("ps-scroll-y", debounce(function () {
        o()
    }, 10)))
}
...
function initNavs() {
    total.forEach(function (l, e) {
        ...
        o.style.padding = "0px", o.style.width = l.querySelector("li:nth-child(1)").offsetWidth + "px", o.style.transform = "translate3d(0px, 0px, 0px)", o.style.transition = ".5s ease", l.onmouseover = function (e) {
...
function notify(e) {
    ...
    n.classList.add("alert", "position-absolute", "top-0", "border-0", "text-white", "w-50", "end-0", "start-0", "mt-2", "mx-auto", "py-2"), n.classList.add("alert-" + e.getAttribute("data-type")), n.style.transform = "translate3d(0px, 0px, 0px)", n.style.opacity = "0", n.style.transition = ".35s ease", setTimeout(function () {
        n.style.transform = "translate3d(0px, 20px, 0px)", n.style.setProperty("opacity", "1", "important")
    }, 100), n.innerHTML = '<div class="d-flex mb-1"><div class="alert-icon me-1"><i class="' + e.getAttribute("data-icon") + ' mt-1"></i></div><span class="alert-text"><strong>' + e.getAttribute("data-title") + '</strong></span></div><span class="text-sm">' + e.getAttribute("data-content") + "</span>", t.appendChild(n), setTimeout(function () {
